    ...
    commands = {
        ...
        setup = {
            ...
            action = function(_options, command, args, cli)
                ...
                log_success("Deviant node setup complete.")
            end
        },
        bootstrap = {
        ...
        validate = {
            ...
            action = function(_options, command, args, cli)
                ...
                -- //TODO: add switches
                ami_assert(proc.EPROC, "Deviant node AMI requires extra api - eli.proc.extra", EXIT_MISSING_API)
                ami_assert(fs.EFS, "Deviant node AMI requires extra api - eli.fs.extra", EXIT_MISSING_API)
                ...
                log_success("Deviant node configuration validated.")
            end
        },
        about = {
